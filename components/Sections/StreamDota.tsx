...
export default function StreamDota(): ReactElement {
    return <Container>
        ...
        <div className={'productionInfo'}>
            Zusammen mit unserem Partner <a href={'https://streamdota.de'}>StreamDota.de</a> können wir den qualitativen Wert der Dota 2- Berichterstattung umfassend verbessern. Durch <span className={'highlight'}>Live-Statistiken</span> kann das Spielgeschehen für den Zuschauer verdeutlicht werden. Eine exklusiv gebrandete <span className={'highlight'}>Voting-Funktion</span> bietet die ideale Möglichkeit zur Produktplatzierung für Ihre Sponsoren - alles individuell anpassbar!
        </div>
