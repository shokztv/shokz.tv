    ...
    <Container bg={"blue"}>
      ...
      <div className={"mainInfo"}>
        ...
        <div className={"description"}>
          <span className={"highlight"}>shokzTV</span> ist der größte
          deutschsprachige Dota 2-Kanal auf der Livestreaming Platform
          Twitch.tv. Es finden Liveübertragungen zu den wichtigsten nationalen &
          internationalen Events der Szene statt. Dazu gehören exklusive Titel
      ...
      <div className={"stats"}>
        ...
        <div className={"stat"}>
          <div className={"icon"}>
            ...
            >
              <path
                d="M17.7064 19.285H11.4905L14.7619 27.2533C14.9897 27.8057 14.7294 28.4251 14.2085 28.6595L11.3278 29.915C10.7907 30.1494 10.1885 29.8815 9.96064 29.3458L6.85207 21.7792L1.7741 27.0022C1.0974 27.6981 0 27.1616 0 26.2489V1.07244C0 0.111498 1.16725 -0.356959 1.77404 0.319155L18.4388 17.4603C19.111 18.1153 18.615 19.285 17.7064 19.285V19.285Z"
                fill="white"
              />
            </svg>
          </div>
